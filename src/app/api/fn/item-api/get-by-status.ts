...
export function getByStatus(http: HttpClient, rootUrl: string, params: GetByStatus$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ItemResponse>>> {
...
getByStatus.PATH = '/item/status/{isActive}';
