...
export class PurchaseOrderService {
  ...
  createOrder(payload: unknown): Observable<PurchaseOrder> {
  ...
  receiveOrder(payload: { purchaseOrderId: number; receiveItems: Array<{ purchaseItemId: number; quantityReceived: number; quantityDamaged: number; expirationDate?: string; }>; }): Observable<PurchaseOrder> {
